...
public:
  ...
  RSUIComponentProps(const PropsParserContext &context, const RSUIComponentProps &sourceProps, const RawProps &rawProps)
    : ViewProps(context, sourceProps, rawProps), RSUIDynamicProps(rawProps) {}
};
